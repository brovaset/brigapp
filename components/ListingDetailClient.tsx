...
import { formatCurrency, calculateBookingPrice, US_STATES } from '@/lib/utils'
...
export type ListingDetailListing = {
  ...
  photos: string[]
  hostId: string
  host?: { id: string; firstName: string; lastName: string } | null
  ratings?: Array<{
    id: string
    rating: number
    comment?: string | null
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg border-2 border-gray-200/80 border-l-4 border-l-car-neon p-6"
            >
              ...
              {amenityList.length > 0 && (
                <div className="flex flex-wrap gap-3 mb-4">
                  {amenityList.map((a: { label: string }) => (
                    <span
                      key={a.label}
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg border-2 border-gray-200/80 border-l-4 border-l-car-electric p-6"
            >
            ...
            {(listing.ratings?.length ?? 0) > 0 && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3 }}
                className="bg-white rounded-xl shadow-lg border-2 border-gray-200/80 border-l-4 border-l-car-turbo p-6"
              >
                <h2 className="text-lg font-semibold text-gray-900 mb-4">
                  Reviews ({listing.ratings!.length})
                </h2>
                <div className="space-y-4">
                  {listing.ratings!.slice(0, 5).map((r) => (
                    <div
                      key={r.id}
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg border-2 border-gray-200/80 border-t-4 border-t-car-neon p-6 sticky top-24"
            >
              <div className="mb-6">
              ...
              <form onSubmit={handleBook} className="space-y-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBookingData({ ...bookingData, vehicleMake: e.target.value })
                  }
                />
                <Input
                  label="Vehicle model"
                  ...
                  onChange={(e) =>
                    setBookingData({ ...bookingData, vehicleModel: e.target.value })
                  }
                />
                <Input
                  label="License plate"
                  ...
                  onChange={(e) =>
                    setBookingData({ ...bookingData, licensePlate: e.target.value })
                  }
                />
                <Select
                  ...
                  onChange={(e) =>
                    setBookingData({
                      ...bookingData,
                      licensePlateState: e.target.value,
                    })
                  }
                />
                {totalPrice > 0 && (
