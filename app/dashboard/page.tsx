...
export default function DashboardPage() {
  ...
  const canSearch = user.role === 'DRIVER' || user.role === 'BOTH'
    ...
    return (
      <FloatingCard glowColor="neutral">
        <div className="text-center py-8">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-car-neon mx-auto"></div>
        </div>
      </FloatingCard>
    )
  }
